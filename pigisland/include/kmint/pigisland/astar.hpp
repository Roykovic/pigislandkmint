...
namespace kmint {
	...
	public:
		...
		std::map<size_t, size_t> astarRecusive(size_t current, size_t end, std::map<size_t, bool> visited, std::map<size_t, int> distanceMap, std::map<size_t, size_t> pathMap, kmint::map::map_graph& graph, bool checkWeight);
